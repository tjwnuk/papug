        ...
        http
                .authorizeRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers("/my-account", "/my-account/**").hasAnyRole("USER", "ADMIN", "MOD")
                                .requestMatchers("/new-post", "/new-post/**").hasAnyRole("USER", "ADMIN", "MOD")
                                .requestMatchers("/mod", "/mod/**").hasAnyRole("MOD", "ADMIN")
